...
module.exports = {
  invoicePdf: (dataCallback, endCallback, orderData) => {
...
function generateCustomerInformation(doc, orderData) {
  ...
  doc
    ...
    .text(`Name: ${orderData.userId.username}`, 300, 100)
    .text(`Phone: ${orderData.addressChosen.phone}`, 300, 130)
    .text(`Address: ${orderData.addressChosen.addressLine1}`, 300, 115)
